...
public class OptionsController : ControllerBase
{
    ...
    public ActionResult<dynamic> saveAll(JObject obj)
    {
        foreach (var x in obj.Properties())
        {
            ...
            if (Post == null)
                _context.WebsiteOptionsTbls.Add(new WebsiteOptionsTbl
                    {OptionKey = x.Name, OptionValue = x.Value.ToString()});
            else
    ...
    private dynamic TryJson(string value)
    {
        try
        {
