    ...
    (function() {
            ...
            EventHandler.on(document,
                ...
                function(event) {
                    ...
                    const
                        instance = component
                            .getOrCreateInstance(
                                target); // Method argument is left, for Alert and only, as it doesn't implement the 'hide' method
        ...
        class Collapse extends BaseComponent {
            ...
            show() {
                ...
                if (this._config.parent) {
                    const children = SelectorEngine.find(`.${CLASS_NAME_COLLAPSE} .${CLASS_NAME_COLLAPSE}`,
                        this._config.parent);
                    actives = SelectorEngine.find(SELECTOR_ACTIVES, this._config.parent)
            ...
            _initializeChildren() {
                ...
                SelectorEngine.find(SELECTOR_DATA_TOGGLE$4, this._config.parent)
                    .filter(elem => !children.includes(elem)).forEach(element => {
        ...
        function getBoundingClientRect(element, includeScale) {
            ...
            if (isHTMLElement(element) && includeScale) {
                ...
                var offsetWidth =
                    element.offsetWidth; // Do not attempt to divide by 0, otherwise we get `Infinity` as scale
        ...
        */
        ...
        class Dropdown extends BaseComponent {
            ...
            show() {
                ...
                const parent =
                    Dropdown.getParentFromElement(this._element); // Totally disable Popper for Dropdowns in Navbar
        ...
        class Tooltip extends BaseComponent {
            ...
            _addAttachmentClass(attachment) {
                this.getTipElement().classList
                    .add(`${this._getBasicClassPrefix()}-${this.updateAttachment(attachment)}`);
            }
